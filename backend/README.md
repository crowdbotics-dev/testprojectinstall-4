...
## Project Structure
    ...
    ├── testprojectinstall_4  # Django project configurations
...
1. Clone this repo and `cd testprojectinstall_4`
...
2. Clone this repo and `cd testprojectinstall_4`
