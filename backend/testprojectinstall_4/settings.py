"""
Django settings for testprojectinstall_4 project.
...
ROOT_URLCONF = 'testprojectinstall_4.urls'
...
WSGI_APPLICATION = 'testprojectinstall_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testprojectinstall_4 API",
    "DESCRIPTION": "API documentation for testprojectinstall_4 App",
    "VERSION": "v1",
}
